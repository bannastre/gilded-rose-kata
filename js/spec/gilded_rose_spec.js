describe("Gilded Rose", function() {
  ...
  describe("Sulfuras", function(){
    ...
    it("doesn't change quality", function(){
      var gildedRose = new Shop([ new Item("Sulfuras, Hand of Ragnaros", 0, 50) ]);
      var items = gildedRose.updateQuality();
      expect(items[0].quality).toEqual(50);
    });

    it("doesn't change sell_in", function(){
      var gildedRose = new Shop([ new Item("Sulfuras, Hand of Ragnaros", 1, 50) ]);
      var items = gildedRose.updateQuality();
      expect(items[0].quality).toEqual(50);
    });
  ...
  describe("Aged Brie", function(){
    ...
    it("increases quality by 1 when you have a sellIn of >0", function(){
      var gildedRose = new Shop([ new Item("Aged Brie", 1, 0) ]);
      var items = gildedRose.updateQuality();
  ...
  describe("Backstage Passes", function(){
    ...
    it("increases quality to 0 when you have a sellIn of <= 0", function(){
      var gildedRose = new Shop([ new Item("Backstage passes to a TAFKAL80ETC concert", 0, 50) ]);
      var items = gildedRose.updateQuality();
      expect(items[0].quality).toEqual(0);
    });

    it("increases quality by 3 when you have a sellIn of >0", function(){
      var gildedRose = new Shop([ new Item("Backstage passes to a TAFKAL80ETC concert", 1, 1) ]);
      var items = gildedRose.updateQuality();
      expect(items[0].quality).toEqual(4);
    });

    it("increases quality by 2 when you have a sellIn of >5", function(){
      var gildedRose = new Shop([ new Item("Backstage passes to a TAFKAL80ETC concert", 6, 1) ]);
      console.log(gildedRose.items[0].quality);
      console.log(gildedRose.items[0].sellIn);
      var items = gildedRose.updateQuality();
    ...
    it("increases quality by 1 when you have a sellIn of >10", function(){
      var gildedRose = new Shop([ new Item("Backstage passes to a TAFKAL80ETC concert", 11, 1) ]);
      var items = gildedRose.updateQuality();
      expect(items[0].quality).toEqual(2);
    });
